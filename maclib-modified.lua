...
--// Library Functions
function MacLib:Title(Text, isRgb)
	local UI = {}

	UI["1"] = Instance.new("ScreenGui")
	UI["1"].Parent = RunService:IsStudio() 
		and LocalPlayer:FindFirstChild("PlayerGui")
		or (gethui and gethui())
		or (cloneref and cloneref(MacLib.GetService("CoreGui")) or MacLib.GetService("CoreGui"))
	...
	UI["2"]["TextXAlignment"] = Enum.TextXAlignment.Right
	UI["2"]["TextScaled"] = true
	UI["2"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
	UI["2"]["TextSize"] = 14
	UI["2"]["FontFace"] = Font.new([[rbxasset://fonts/families/Arial.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
	...
	UI["4"] = Instance.new("UITextSizeConstraint", UI["2"])
	UI["4"]["MaxTextSize"] = 28

	UI["5"] = Instance.new("UIAspectRatioConstraint", UI["2"])
	UI["5"]["AspectRatio"] = 11.32976
	...
	if isRgb then
		...
		RunService.RenderStepped:Connect(function(deltaTime)
			hue = (hue + speed * deltaTime) % 1
			UI["2"].TextColor3 = Color3.fromHSV(hue, 1, 1)
		end)
	end
end
